...
global.sig = 'https://instagram.com/aiman1_23' //Link Instagrammu
global.sgh = 'https://github.com/aiman-tzy' //Link Githubmu
global.sgc = '-'
...
global.ppulsa = '0102810046' //Nomor SimCard Yang Kamu Pake
global.pgopay = '-'
global.povo = '-'
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '60108454028' //Nomor Bot
global.nomorown = '60102810046' //Nomor Owner
global.namebot = 'ᚯlynxメ฿Ø₮™' //Nama Bot
global.nameown = '༄ᶜAiman☆࿐' // Nama Owner
global.wame = 'https://api.whatsapp.com/send?phone=+60102810046'
global.tautanwa = 'https://api.whatsapp.com/send?phone=+60102810046' //kalau bisa link wa bisnis kalian


/*============== STAFF ==============*/
global.owner = [
  ['60102810046', '❦ ༄ᶜlynxaiman☆࿐ 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ᚯlynxメ汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ᚯlynxメ฿Ø₮™˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ᚯlynxメ฿Ø₮™'
global.namedoc = 'ᚯlynxメ' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋 ┊ ᚯlynx ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ lynx ʙᴏᴛᴢ'
